...
A simple desktop tool built with Electron to **inspect and edit `level.dat` files** from Minecraft Java Edition worlds.
...
A minimal structure for NBT Control looks like this: